...
public class UsersController {
    ...
    public String register(Model model) {
        ...
        model.addAttribute("getAllTypes", usersTypes);  // İsimlendirme düzeltilmeli
    ...
    public String userRegistration(@Valid Users users){ // public String userRegistration(@Valid Users users, Model model) değiştirildi.
